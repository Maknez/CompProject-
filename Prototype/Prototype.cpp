...
Point flashFinder(String zmiennaWejsciowa) {
	Mat imgOriginal; 
	Mat hsvImg;   
	Mat binaryImg; 
	Mat binaryImg1; 
	...
	imgOriginal = imread("TestImages/FlashImages/InputTestImages/" + zmiennaWejsciowa + ".jpg");          
	...
	imshow(zmiennaWejsciowa, imgOriginal);
	waitKey(30);
...
int main(int argc, char** argv) {
	...
	Point point = flashFinder(zmiennaWejsciowa2);
